...
**IMPORTANT! ELS NOMS DE LES COLUMNES NO CANVIEN, PERÒ SÍ ELS SEUS VALORS, PER TANT, ENCARA QUE LES COLUMNES ES DIGUIN "sqft_[...]", ELS VALORS NO SON PEUS SINÓ METRES! EN EL CAS DE LA COLUMNA DE PREUS, ELS VALORS CORRESPONEN A EUROS I NO A DÒLARS!**
...
- _floors_ -> Actualment és de tipus numèric. En aquest cas, no s'ha trobat cap explicació per als decimals d'aquesta variable, per tant es decideix fer el canvi a _integer_.
